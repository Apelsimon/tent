...
public:
    ...
    static byte_buffer handshake(const std::string& peer_id, const std::string& info_hash);
    ...
    static byte_buffer connect(uint32_t transaction_id);
